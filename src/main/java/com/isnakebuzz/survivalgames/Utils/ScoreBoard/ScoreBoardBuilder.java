...
public class ScoreBoardBuilder {
    ...
    public ScoreBoardBuilder(final String score_name, boolean health, boolean spect, boolean gamePlayers) {
        ...
        if (gamePlayers) {
            this.gamePlayers = this.scoreboard.registerNewTeam("Game");
            this.gamePlayers.setPrefix(color("&e"));
            this.gamePlayers.setCanSeeFriendlyInvisibles(false);
            this.gamePlayers.setAllowFriendlyFire(true);
        }

    }

    public void updatelife(Arena arena) {
        for (Player onlinePlayers : arena.getGamePlayers()) {
    ...
    public void updatespect(Arena arena) {
    ...
    public void updategames(Arena arena) {
        for (Player p : arena.getGamePlayers()) {
            if (!this.gamePlayers.hasPlayer(p)) {
                this.gamePlayers.addPlayer(p);
            }
        }
    }
