package com.isnakebuzz.survivalgames.Inventory.Utils;
...
public class ItemBuilder {
    ...
    public static ItemStack crearItem1(Arena arena, final int n, final int n2, final int n3, final String s, final List<String> list) {
        final ItemStack itemStack = new ItemStack(n, n2, (short) n3);
        final ItemMeta itemMeta = itemStack.getItemMeta();
        itemMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', s));
        final ArrayList<String> lore = new ArrayList<String>();
