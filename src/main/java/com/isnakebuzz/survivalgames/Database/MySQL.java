        ...
        if (!isConnected()) {
            try {
                if (MySQL.isEnabled) {
                    ...
                    plugin.log("SurvivalGames", "Has been connected to MySQL Connection.");
                } else {
                    ...
                    plugin.log("SurvivalGames", "Has been loaded SQLite File.");

                }
            } catch (SQLException e) {
                plugin.log("SurvivalGames", "&cError connecting to MySQL Connection");
                e.printStackTrace();
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
                plugin.log("SurvivalGames", "&cError loading SQLite Connection");
            }
        }
    }
